...
import com.eg0n.startools.telosys.persistence.entities.CrewShipUpgrades;

/**
 * Spring Data JPA repository for entity "CrewShipUpgrades" <br> 
 * 
 ...
 *
 */
public interface CrewShipUpgradesRepository extends PagingAndSortingRepository<CrewShipUpgrades, Integer> {

	// Insert specific finders here 

	//List<CrewShipUpgrades> findByXxx(String xxx);

	//List<CrewShipUpgrades> findByXxxStartingWith(String xxx);

	//List<CrewShipUpgrades> findByXxxContaining(String xxx);

	//List<CrewShipUpgrades> findByYyy(BigDecimal yyy);

	//List<CrewShipUpgrades> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
