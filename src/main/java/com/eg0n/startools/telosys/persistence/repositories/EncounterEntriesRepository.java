...
import com.eg0n.startools.telosys.persistence.entities.EncounterEntries;

/**
 * Spring Data JPA repository for entity "EncounterEntries" <br> 
 * 
 ...
 *
 */
public interface EncounterEntriesRepository extends PagingAndSortingRepository<EncounterEntries, Integer> {

	// Insert specific finders here 

	//List<EncounterEntries> findByXxx(String xxx);

	//List<EncounterEntries> findByXxxStartingWith(String xxx);

	//List<EncounterEntries> findByXxxContaining(String xxx);

	//List<EncounterEntries> findByYyy(BigDecimal yyy);

	//List<EncounterEntries> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
