...
import com.eg0n.startools.telosys.persistence.entities.EquipmentTypes;

/**
 * Spring Data JPA repository for entity "EquipmentTypes" <br> 
 * 
 ...
 *
 */
public interface EquipmentTypesRepository extends PagingAndSortingRepository<EquipmentTypes, Integer> {

	// Insert specific finders here 

	//List<EquipmentTypes> findByXxx(String xxx);

	//List<EquipmentTypes> findByXxxStartingWith(String xxx);

	//List<EquipmentTypes> findByXxxContaining(String xxx);

	//List<EquipmentTypes> findByYyy(BigDecimal yyy);

	//List<EquipmentTypes> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
