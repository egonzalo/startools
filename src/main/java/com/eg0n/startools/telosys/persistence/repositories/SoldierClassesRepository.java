...
import com.eg0n.startools.telosys.persistence.entities.SoldierClasses;

/**
 * Spring Data JPA repository for entity "SoldierClasses" <br> 
 * 
 ...
 *
 */
public interface SoldierClassesRepository extends PagingAndSortingRepository<SoldierClasses, Integer> {

	// Insert specific finders here 

	//List<SoldierClasses> findByXxx(String xxx);

	//List<SoldierClasses> findByXxxStartingWith(String xxx);

	//List<SoldierClasses> findByXxxContaining(String xxx);

	//List<SoldierClasses> findByYyy(BigDecimal yyy);

	//List<SoldierClasses> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
