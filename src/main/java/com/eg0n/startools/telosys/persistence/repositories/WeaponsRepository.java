...
import com.eg0n.startools.telosys.persistence.entities.Weapons;

/**
 * Spring Data JPA repository for entity "Weapons" <br> 
 * 
 ...
 *
 */
public interface WeaponsRepository extends PagingAndSortingRepository<Weapons, Integer> {

	// Insert specific finders here 

	//List<Weapons> findByXxx(String xxx);

	//List<Weapons> findByXxxStartingWith(String xxx);

	//List<Weapons> findByXxxContaining(String xxx);

	//List<Weapons> findByYyy(BigDecimal yyy);

	//List<Weapons> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
